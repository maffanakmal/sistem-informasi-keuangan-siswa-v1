...
<head>
    ...
    <title>Slip Pembayaran Kegiatan</title>
    <style>
        body {
...
<body onload="window.print()">
    <h3 align="center">SMP NURUL IMAN <b><br>BUKTI PEMBAYARAN KEGIATAN</b></h3>
    <hr>
    <?php
    $nisn = $_GET['nisn'];
    $query = mysqli_query($conn, "SELECT * FROM siswa
                                    ...
                                    JOIN kegiatan ON siswa.id_kegiatan = kegiatan.id_kegiatan
