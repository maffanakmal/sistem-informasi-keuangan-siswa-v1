        ...
        <aside id="sidebar" class="bg-success">
            <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#masterData" aria-expanded="false" aria-controls="masterData">
                            Master Data
                        </a>
                        <ul id="masterData" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="spp.php" class="sidebar-link">Data SPP</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="buku.php" class="sidebar-link">Data Buku</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="kegiatan.php" class="sidebar-link">Data Kegiatan</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="ppdb.php" class="sidebar-link">Data PPBD</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="kelas.php" class="sidebar-link">Data Kelas</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="siswa.php" class="sidebar-link">Data Siswa</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="petugas.php" class="sidebar-link">Data Petugas</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
