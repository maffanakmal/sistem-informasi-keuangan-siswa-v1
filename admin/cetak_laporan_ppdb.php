...
if (isset($_GET['awal']) && isset($_GET['akhir'])) {
    ...
    if (empty($awal) || empty($akhir)) {
        echo "<script>alert('Isi tanggal terlebih dahulu!')
                    window.location.href = 'histori_pembayaran_ppdb.php';
                </script>";
        die();
    }
...
<head>
    ...
    <title>Cetak Laporan Pembayaran PPDB</title>
    <style>
        body {
...
<body onload="window.print()">
    <h3 align="center">SMP NURUL IMAN <b><br>LAPORAN PEMBAYARAN PPDB</b></h3>
    <br>
    ...
    <table border="1" cellspacing="" cellpadding="4" width="100%">
        ...
        <?php
        $nomor = 1;
        $query = mysqli_query($conn, "SELECT * FROM pembayaran_ppdb, siswa, kelas, ppdb, petugas 
