...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="cetak_laporan_buku.php" method="GET" target="_blank">
...
<div class="card mb-4">
    <div class="card-header bg-success py-3 d-flex justify-content-between">
        <h5 class="m-0 font-weight-bold text-light">Histori Transaksi Pembayaran Buku</h5>
    </div>
    <div class="card-body">
        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
            ...
            <tbody>
                <?php
                $number = 1;
                $query = "SELECT * FROM pembayaran_buku, siswa, kelas, buku, petugas WHERE pembayaran_buku.nisn = siswa.nisn
