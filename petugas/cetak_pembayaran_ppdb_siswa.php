...
<head>
    ...
    <title>Slip Pembayaran PPDB</title>
    <style>
        body {
...
<body onload="window.print()">
    <h3 align="center">SMP NURUL IMAN <b><br>BUKTI PEMBAYARAN PPDB</b></h3>
    <hr>
    <?php
    $nisn = $_GET['nisn'];
    $query = mysqli_query($conn, "SELECT * FROM siswa, spp, kelas,ppdb
