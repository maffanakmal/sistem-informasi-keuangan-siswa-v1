...
if (isset($_GET['awal']) && isset($_GET['akhir'])) {
    ...
    if (empty($awal) || empty($akhir)) {
        echo "<script>alert('Isi tanggal terlebih dahulu!')
                    window.location.href = 'histori_pembayaran_kegiatan.php';
                </script>";
        die();
    }
...
<head>
    ...
    <title>Cetak Laporan Pembayaran Kegiatan</title>
    <style>
        body {
...
<body onload="window.print()">
    <h3 align="center">SMP NURUL IMAN <b><br>LAPORAN PEMBAYARAN KEGIATAN</b></h3>
    <br>
    ...
    <table border="1" cellspacing="" cellpadding="4" width="100%">
        ...
        <?php
        $nomor = 1;
        $query = mysqli_query($conn, "SELECT * FROM pembayaran_kegiatan, siswa, kelas, kegiatan, petugas 
                                        ...
                                        ORDER BY id_pembayaran_kegiatan");
        $total = 0;
